...
public class ConfigUtil {
    ...
    public static VueConfig getVueConfig(String name) throws Exception {
        Connection conn = null;
        Statement stat = null;
        ResultSet rs = null;
        try {
            ...
            while (resultSet.next()) {
                JSONObject object = JSON.parseObject(resultSet.getString("value"), JSONObject.class);
                VueConfig result = new VueConfig(object);
                return result;
            }
        } finally {
            if (rs != null) {
     ...
     * @throws Exception
     */
    public static int saveVueConfig(VueConfig config, String name) throws Exception {
        Connection conn = null;
        Statement stat = null;
        ResultSet rs = null;
        try {
