...
public interface Constant {
	...
	/** vue的后缀名.vue */
	static final String VUE_SUFFIX = ".vue";
	...
	/** vue模板的默认名字 */
	static final String TEMPLATE_NAME_VUE = "Vue.ftl";
	/** Service模板的默认名字 */
	...
	/** Mapper模板的默认名字 */
	static final String TEMPLATE_NAME_MAPPER = AppMain.LANGUAGE.get(LanguageKey.SET_ABSTRACT_AUTOMATIC).get();
	/** Mapper模板的默认名字 */
