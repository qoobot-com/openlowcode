...
public class JavaType {
	...
	public static boolean isString(String str) {
		if (str.equalsIgnoreCase("NCHAR") || str.equalsIgnoreCase("CHAR") || str.equalsIgnoreCase("NVARCHAR2")
				...
				|| str.equalsIgnoreCase("XML") || str.equalsIgnoreCase("IMAGE") || str.equalsIgnoreCase("TEXT")|| str.equalsIgnoreCase("LONGTEXT")
				|| str.equalsIgnoreCase("ENUM") || str.equalsIgnoreCase("JSON")|| str.equalsIgnoreCase("SET")){
			return true;
		} else {
			return false;
		}
