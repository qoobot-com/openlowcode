...
public class AboutController extends BaseController {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		lblVersion.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_Version));
		lblInstructions.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_INSTRUCTIONS));
		...
		lblProjectPath.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_PROJECT_PATH));
		...
		lblTemplatePath.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_TEMPLATE_PATH));
		...
		lblTalkGroupInQQ.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_TALK_GROUP_IN_QQ));
		...
		lblAuthorsEmail.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.INSTRUCTION_LBL_AUTHORS_EMAIL));
