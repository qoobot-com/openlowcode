...
import com.bltu.generator.models.TableAttributeKeyValueTemplateEditingCell;
import com.bltu.generator.options.CustomConfig;
...
public class SetCustomController extends BaseController {
	 ...
	 */
	public void init() {
		logger.debug("初始化SetCustomConterller...");
		logger.debug("初始化SetCustomConterller->初始化属性...");
		// 添加右键删除属性
		...
		logger.debug("初始化SetCustomConterller->初始化模板文件名选择...");
		logger.debug("初始化SetCustomConterller->初始化配置信息...");
		...
		initLanguage();
		logger.debug("初始化SetCustomConterller-->成功!");
	}
	...
	private void initLanguage() {
		...
		tdClassName.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_COMMON_CLASS_NAME));
		tdSuffix.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_COMMON_SUFFIX));
		tdPackageName.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_COMMON_PACKAGE_NAME));
		tdTemplate.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_COMMON_TEMPLATE_NAME));
		lblAddCustomProperty.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_LBL_ADD_CUSTOM_PROPERTY));
		lblPackageName.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_LBL_PACKAGE_NAME));
		lblClassName.textProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_LBL_CLASS_NAME));
		...
		txtPackageName.promptTextProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_TXT_PACKAGE_NAME));
		txtClassName.promptTextProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_TXT_CLASS_NAME));
	...
	public void loadConfig(CustomConfig config) {
		...
		if (config != null && config.getTableItem() != null) {
			config.getTableItem().forEach(v -> {
				...
				attribute.getTemplate().promptTextProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
	...
	public void onAddPropertyToTable(ActionEvent event) {
		...
		comboBox.promptTextProperty().bind(AppMain.LANGUAGE.get(LanguageKey.SET_CBO_TEMPLATE));
