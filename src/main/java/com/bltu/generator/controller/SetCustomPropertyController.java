...
import com.bltu.generator.options.CustomPropertyConfig;
...
public class SetCustomPropertyController extends BaseController {
	 ...
	 */
	public void init() {
		logger.debug("初始化SetCustomPropertyController...");
		logger.debug("初始化SetCustomPropertyController->初始化属性...");
		// 添加右键删除属性
		...
		logger.debug("初始化SetCustomPropertyController->初始化配置信息...");
		...
		initLanguage();
		logger.debug("初始化SetCustomPropertyController-->成功!");
	}
