...
import com.bltu.generator.options.EntityConfig;
...
public class SetEntityAttributeController extends BaseController {
	 ...
	 */
	public void init() {
		logger.debug("初始化SetEntityAttribute...");
		logger.debug("初始化SetEntityAttribute->初始化属性...");
		// 添加右键删除属性
		...
		logger.debug("初始化SetEntityAttribute->初始化模板文件名选择...");
		...
		logger.debug("初始化SetEntityAttribute->初始化配置信息...");
		...
		logger.debug("初始化SetEntityAttribute-->成功!");
	}
