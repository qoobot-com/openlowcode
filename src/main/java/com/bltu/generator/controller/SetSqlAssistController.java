...
import com.bltu.generator.options.SqlAssistConfig;
...
public class SetSqlAssistController extends BaseController {
	 ...
	 */
	public void init() {
		logger.debug("初始化SetSqlAssistController...");
		logger.debug("初始化SetSqlAssistController->初始化属性...");
		// 添加右键删除属性
		...
		logger.debug("初始化SetSqlAssistController->初始化模板文件名选择...");
		...
		logger.debug("初始化SetSqlAssistController->初始化配置信息...");
		...
		initLanguage();
		logger.debug("初始化SetSqlAssistController-->成功!");
	}
