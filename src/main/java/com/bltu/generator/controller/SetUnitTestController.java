...
import com.bltu.generator.options.UnitTestConfig;
...
public class SetUnitTestController extends BaseController {
	 ...
	 */
	public void init() {
		logger.debug("初始化SetUnitTestConterller...");
		logger.debug("初始化SetUnitTestConterller->初始化属性...");
		// 添加右键删除属性
		...
		logger.debug("初始化SetUnitTestConterller->初始化模板文件名选择...");
		...
		logger.debug("初始化SetUnitTestConterller->初始化配置信息...");
		...
		initLanguage();
		logger.debug("初始化SetUnitTestConterller-->成功!");
	}
