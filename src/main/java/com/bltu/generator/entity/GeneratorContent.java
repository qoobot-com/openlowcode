...
public class GeneratorContent {
	...
	public VueContent getVue() {
		return vue;
	}

	public void setVue(VueContent vue) {
		this.vue = vue;
	}
	...
	public String toString() {
		return "GeneratorContent [database=" + database + ", entity=" + entity + ", service=" + service + ", serviceImpl=" + serviceImpl
				+ ", data=" + dao + ", mapper=" + mapper + ", controller=" + controller + ", unitTest=" + unitTest + ", assist=" + assist
