...
public class HistoryConfig {
	...
	public HistoryConfig(String projectPath, String entityPackage, String entityName,String vuePackage, String vueName, String servicePackage, String serviceName,
	...
	public VueConfig getVueConfig() {
		return vueConfig;
	}

	public void setVueConfig(VueConfig vueConfig) {
	...
	public String getVuePackage() {
		return vuePackage;
	}

	public void setVuePackage(String vuePackage) {
		this.vuePackage = vuePackage;
	}
